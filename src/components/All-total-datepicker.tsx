import style from "../styles/all-total-datepicker.module.scss";
...
const AllTotalDatepicker: React.FC<DateRangePickerProps> = ({ onDateChange }) => {
...
export default AllTotalDatepicker;
